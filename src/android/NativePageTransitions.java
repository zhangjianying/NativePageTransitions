                    ...
                    public void run() {
                        ...
                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
                            if (slowdownfactor != 1 && ("left".equals(direction) || "up".equals(direction))) {
                                if (slidePixels <= 0) {
                                    ...
                                    imageViewAnimation2.setFillAfter(true);
                        ...
                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
                            if (slidePixels <= 0 &&
                                ...
                                webViewAnimation2.setFillAfter(true);
    ...
    private Bitmap getBitmap() {
        ...
        if (isCrosswalk) {
            ...
            if (view instanceof ViewGroup) {
                try {
                    final ViewGroup setChildrenDrawingCacheEnabled = (ViewGroup) view.getClass().getMethod("setChildrenDrawingCacheEnabled").invoke(view, true);
            ...
            if (view instanceof ViewGroup) {
                try {
                    final ViewGroup setChildrenDrawingCacheEnabled = (ViewGroup) view.getClass().getMethod("setChildrenDrawingCacheEnabled").invoke(view, false);
                } catch (IllegalAccessException e) {
                    e.printStackTrace();
                } catch (InvocationTargetException e) {
                    e.printStackTrace();
